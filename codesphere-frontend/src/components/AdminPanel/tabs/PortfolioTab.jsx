...
const CATS = ['Web', 'E-commerce', 'SaaS', 'Mobile', 'Other'];
const EMPTY = { title: '', subtitle: '', description: '', image: '', liveUrl: '', githubUrl: '', category: 'Web', tags: [], featured: false };
                    ...
                    <div className="admin-modal" onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="admin-form-group">
                                ...
                                <input value={form.subtitle} onChange={e => setForm({ ...form, subtitle: e.target.value })} placeholder="e.g. Mental Health Care Platform" />
                            </div>
                            <div className="admin-form-group">
                                <label>Description</label>
                                <textarea required rows="3" value={form.description} onChange={e => setForm({ ...form, description: e.target.value })} />

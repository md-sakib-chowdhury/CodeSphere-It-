...
export default function ServicesTab() {
    ...
    const handleHeroImage = (e) => {
        ...
        reader.onload = () => {
            ...
            setPageHeader({ ...pageHeader, heroImage: reader.result, heroBgType: 'image' });
        };
        reader.readAsDataURL(file);
    };
    const removeHeroImage = () => {
        setHeroImagePreview('');
        setPageHeader({ ...pageHeader, heroImage: '', heroBgType: 'image' });
    };
            ...
            <div className="admin-table-wrap" style={{ marginBottom: '2rem', padding: '1.5rem' }}>
                ...
                <form onSubmit={(e) => { e.preventDefault(); saveSection('servicesPageHeader', pageHeader, 'Page header'); }}>
                    ...
                    <div className="admin-form-group">
                        ...
                        <p style={{ color: 'var(--gray-400)', fontSize: 13, marginTop: -4, marginBottom: 10 }}>
                            Shown as the /services page hero background.
                        </p>
                        {heroImagePreview && (

...
const EMPTY = { name: '', designation: '', bio: '', image: '', linkedin: '', github: '', twitter: '', skills: [], group: 'core' };
...
export default function TeamTab() {
    ...
    const openCreate = () => { setEditing(null); setForm(EMPTY); setPreview(''); setShowModal(true); };
    const openEdit = (m) => { setEditing(m); setForm({ ...EMPTY, ...m }); setPreview(m.image || ''); setShowModal(true); };
                        ...
                        <div key={m._id} className="admin-list-item">
                            ...
                            <div className="admin-list-info">
                                ...
                                <div className="admin-list-sub">
                                    {m.designation} · <span style={{ textTransform: 'capitalize', color: m.group === 'executive' ? 'var(--orange-500, #f97316)' : 'var(--blue-500, #3b82f6)' }}>{m.group || 'core'}</span>
                                </div>
                            </div>
                            <div className="admin-list-actions">
                                <button className="admin-icon-btn" onClick={() => openEdit(m)}><FiEdit2 size={15} /></button>

...
//     title: "We're Professional and More Experience",
//     subtext: 'Stay ahead with our best MERN stack development team in Bangladesh — the perfect blend of cutting-edge technologies and industry expertise.',
//     image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&q=80',
//     caption: '2+ years of combined experience in this field',
//     skills: [
//         { label: 'Web Development', value: 96 },
//         { label: 'UI/UX Design', value: 93 },
//         { label: 'Cyber Security', value: 88 },
...
//             if (r.data?.keyCompetency) {
//                 setSection({
//                     ...DEFAULT_SECTION,
//                     ...r.data.keyCompetency,
//                     skills: r.data.keyCompetency.skills?.length ? r.data.keyCompetency.skills : DEFAULT_SECTION.skills,
//                 });
//             }
//         }).catch(() => { });
//     }, []);
...
//                     <h2 className="kc-title">{section.title}</h2>
//                     <p className="kc-sub">{section.subtext}</p>
//                     <div className="kc-circles">
...
//                 <div className="kc-img-wrap">
//                     <img src={section.image} alt="Development team at work" />
//                     <div className="kc-img-caption">
//                         {section.caption}
//                     </div>
//                 </div>
...
const mergeSection = (raw) => ({
    ...DEFAULT_SECTION,
    ...raw,
    skills: raw?.skills?.length ? raw.skills : DEFAULT_SECTION.skills,
});
...
export default function KeyCompetency() {
    ...
    useEffect(() => {
        api.get('/home-sections').then(r => {
            if (r.data?.keyCompetency) setSection(mergeSection(r.data.keyCompetency));
        }).catch(() => { });

        // 🔴 admin panel theke Save korle instantly update, refresh lagbe na
        const handleUpdate = (event) => {
            if (event.model !== 'HomeSections') return;
            if (!event.payload?.keyCompetency) return;
            setSection(mergeSection(event.payload.keyCompetency));
        };

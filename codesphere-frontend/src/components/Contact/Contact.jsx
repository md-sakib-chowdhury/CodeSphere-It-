...
//     useEffect(() => {
//         api.get('/contact-page').then(r => setPage({ ...DEFAULT_PAGE, ...r.data })).catch(() => { });
//     }, []);
...
//             <div className="contact-hero">
//                 <div className="contact-hero-inner">
//                     <p className="contact-breadcrumb"><span>Home</span> » {page.breadcrumbCurrent}</p>
...
//                     <div>
//                         <h4>Address</h4>
//                         <p>{page.addressLine1}<br />{page.addressLine2}</p>
//                     </div>
//                 </div>
//             </div>
        ...
        <div className="contact-page">
            ...
            <div
                ...
                style={page.bannerImage ? {
                    backgroundImage: `linear-gradient(rgba(10,14,12,0.55), rgba(10,14,12,0.7)), url(${page.bannerImage})`,

...
//     secondaryBtn: 'Learn More',
//     secondaryBtnLink: '/explore-us',
//     // Background control fields
//     backgroundType: 'particles', // 'particles' | 'image'
...
// // hex color (#4ade80) কে rgba স্ট্রিং এ কনভার্ট করার হেল্পার
// function hexToRgba(hex, alpha) {
//     const clean = (hex || '#4ade80').replace('#', '');
...
//     // এই useEffect শুধু backgroundType === 'particles' হলেই চলবে
//     useEffect(() => {
//         if (data.backgroundType === 'image') return; // ইমেজ মোডে অ্যানিমেশন দরকার নেই
...
//         const dotColor = hexToRgba(data.particleColor, 1);
//         const lineColorBase = data.particleColor || '#4ade80';
...
//                     const dist = Math.hypot(a.x - b.x, a.y - b.y);
//                     if (dist < 130) {
//                         ctx.strokeStyle = hexToRgba(lineColorBase, (1 - dist / 130) * 0.55);
//                         ctx.lineWidth = 1;
//                         ctx.beginPath();
//                         ctx.moveTo(a.x, a.y);
//                         ctx.lineTo(b.x, b.y);
...
//             window.removeEventListener('resize', onResize);
//         };
//     }, [data.backgroundType, data.particleColor]);

//     const isImageBg = data.backgroundType === 'image' && data.bgImage;
...
//             } : undefined}
//         >
//             {/* Particle অ্যানিমেশন — শুধু 'particles' মোডে */}
//             {!isImageBg && <canvas ref={canvasRef} className="hero-canvas" />}

//             {/* ইমেজ মোডে অন্ধকার ওভারলে, যাতে সাদা টেক্সট পড়তে সমস্যা না হয় */}
//             {isImageBg && (
//                 <div
//                     className="hero-image-overlay"
//                     style={{ background: `rgba(10,14,12,${data.bgOverlayOpacity ?? 0.6})` }}
//                 />
//             )}
...
const DEFAULT = {
    ...
    subtext: 'It takes years to build a reputation, and only one bad system to damage it. AMANAH IT delivers secure, modern MERN Stack solutions built for trust and growth.',
    primaryBtn: 'What We Serve',
    // "Start a project" type CTA generally-e /contact-e niye jaoa uchit, kono specific service page-e na
